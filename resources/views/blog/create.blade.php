...
<div class="container">
  ...
  <div class="header">
    <h2 class="text-center fw-bold text-uppercase mt-3 mb-4">Create new post</h2>
    <hr>
  </div>
      ...
      <div class="col-lg-6 col-md-6 mt-5 mb-2">
        ...
        <form method="POST" action="/blog" enctype="multipart/form-data">
          ...
          <div class="form-group mb-3 mt-1">
            ...
            <textarea type="text" class="form-control" id="description-post" rows="8" cols="80" name="description">{{old('description')}}</textarea>
            @error('description')
              <div class="px-1 py-1 mt-2 alert alert-danger">
                {{$message}}
              </div>
         ...
         <div class="form-group mb-3 mt-5 text-center">
           <button type="submit" class="d-inline-block w-25 btn btn-success">Add</button>
         </div>
